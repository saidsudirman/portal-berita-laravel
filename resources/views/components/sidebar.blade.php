<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="index.html">Portal Berita DIPA</a>
        </div>
        ...
        <ul class="sidebar-menu">
            <li class="{{ Request::is('dashboard.index') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ route('dashboard') }}"><i class="far fa-square"></i> <span>Dashboard</span></a>
            ...
            <li class="menu-header">Kelola Portal Berita</li>
            <li class="{{ Request::is('admin.index') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ route('admin') }}"><i class="far fa-square"></i> <span>Admin</span></a>
            </li>
            <li class="{{ Request::is('berita.index') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ route('berita') }}"><i class="far fa-square"></i> <span>Berita</span></a>
            </li>
            <li class="{{ Request::is('kategori.index') ? 'active' : '' }}">
                <a class="nav-link"
